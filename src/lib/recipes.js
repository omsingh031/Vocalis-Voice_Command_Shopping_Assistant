...
export const RECIPE_KNOWLEDGE_BASE = {
  ...
  'dal makhani': {
    ...
    category: 'indian_sweets',
    emoji: '🍲',
    desc: 'Rich creamy black lentils cooked with butter, cream, tomatoes, and spices.',
    ingredients: [
      { name: 'Whole Black Urad Dal', quantity: 1, unit: 'pack', category: 'pantry', status: 'confirmed' },
      { name: 'Rajma (Kidney Beans)', quantity: 1, unit: 'pack', category: 'pantry', status: 'confirmed' },
      { name: 'Butter & Fresh Cream', quantity: 1, unit: 'pack', category: 'dairy', status: 'confirmed' },
      { name: 'Tomato Puree & Onions', quantity: 1, unit: 'pack', category: 'produce', status: 'confirmed' },
      { name: 'Ginger Garlic Paste', quantity: 1, unit: 'pack', category: 'produce', status: 'confirmed' },
      { name: 'Garam Masala & Kasuri Methi', quantity: 1, unit: 'pack', category: 'pantry', status: 'confirmed' },
    ],
  },
  'dal makhni': {
    title: 'Dal Makhani',
  ...
  'butter chicken': {
    ...
    category: 'meat',
    emoji: '🍗',
    desc: 'Tender chicken pieces cooked in a rich, velvety tomato, butter, and cream gravy.',
    ingredients: [
      { name: 'Boneless Chicken', quantity: 500, unit: 'g', category: 'protein', status: 'confirmed' },
      { name: 'Butter & Fresh Cream', quantity: 1, unit: 'pack', category: 'dairy', status: 'confirmed' },
      { name: 'Tomato Puree', quantity: 1, unit: 'pack', category: 'produce', status: 'confirmed' },
      { name: 'Yogurt / Curd', quantity: 1, unit: 'pack', category: 'dairy', status: 'confirmed' },
      { name: 'Ginger Garlic Paste', quantity: 1, unit: 'pack', category: 'produce', status: 'confirmed' },
      { name: 'Kasuri Methi & Spices', quantity: 1, unit: 'pack', category: 'pantry', status: 'confirmed' },
    ],
  },
  'shahi paneer': {
    title: 'Shahi Paneer',
    category: 'indian_sweets',
    emoji: '🧀',
    desc: 'Cottage cheese cubes simmered in a creamy cashew and tomato gravy.',
    ingredients: [
      { name: 'Fresh Paneer', quantity: 400, unit: 'g', category: 'dairy', status: 'confirmed' },
      { name: 'Cashew Paste & Cream', quantity: 1, unit: 'pack', category: 'dairy', status: 'confirmed' },
      { name: 'Tomatoes & Onions', quantity: 1, unit: 'pack', category: 'produce', status: 'confirmed' },
      { name: 'Whole Spices & Shahi Masala', quantity: 1, unit: 'pack', category: 'pantry', status: 'confirmed' },
      { name: 'Desi Ghee', quantity: 1, unit: 'jar', category: 'dairy', status: 'confirmed' },
    ],
  },
  'chole bhature': {
    title: 'Chole Bhature',
    ...
    ingredients: [
      { name: 'Kabuli Chana (Chickpeas)', quantity: 1, unit: 'pack', category: 'pantry', status: 'confirmed' },
      { name: 'Maida (Refined Flour)', quantity: 1, unit: 'kg', category: 'pantry', status: 'confirmed' },
      { name: 'Chole Masala & Spices', quantity: 1, unit: 'pack', category: 'pantry', status: 'confirmed' },
      { name: 'Onions & Tomatoes', quantity: 1, unit: 'pack', category: 'produce', status: 'confirmed' },
      { name: 'Cooking Oil', quantity: 1, unit: 'liter', category: 'pantry', status: 'confirmed' },
    ],
  },
  'gajar ka halwa': {
